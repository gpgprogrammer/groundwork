...
export const PLUS = {
  ...
  trialDays: Number(process.env.NEXT_PUBLIC_PLUS_TRIAL_DAYS || 365),
  features: [
    ...
    { key: "calendar", title: "Calendar sync", body: "Google, Canvas, Schoology, Apple, or Outlook. Quizzes and tests line up the right videos days ahead." },
...
export const SPRINT = {
  ...
  features: [
    ...
    { title: "A day-by-day plan to exam day", body: "Exactly what to watch and practice each day, sized to the time you have." },
